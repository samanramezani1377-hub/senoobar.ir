                ...
                <section class="senoobar-cart-products">
                    <div class="senoobar-cart-card">
                        ...
                        <div class="senoobar-cart-table-header">
                            ...
                            <div class="price-col">قیمت</div>
                            <div class="quantity-col">تعداد</div>
                            <div class="subtotal-col">جمع</div>
                                ...
                                <article class="senoobar-cart-item" data-cart-key="<?php echo esc_attr( $cart_item_key ); ?>">
                                    <div class="senoobar-cart-product">
                                        ...
                                        <div class="senoobar-cart-product-info">
                                            <?php if ( $product_permalink ) : ?>
                                                <a class="senoobar-cart-product-name" href="<?php echo esc_url( $product_permalink ); ?>">
                                                    <?php echo esc_html( $product_name ); ?>
                                                </a>
                                            <?php else : ?>
                                                <span class="senoobar-cart-product-name"><?php echo esc_html( $product_name ); ?></span>
                                            <?php endif; ?>
                                            ...
                                            <?php if ( $_product->get_sku() ) : ?>
                                                <span class="senoobar-product-sku">
                                                    کد محصول: <?php echo esc_html( $_product->get_sku() ); ?>
                                                </span>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="senoobar-cart-price">
                                        <span class="senoobar-mobile-label">قیمت</span>
                                        <span><?php echo wp_kses_post( $unit_price ); ?></span>
                                    </div>

                                    <div class="senoobar-cart-quantity">
                                        <span class="senoobar-mobile-label">تعداد</span>
                                        <div class="senoobar-quantity-control">
                                            <button type="button" class="senoobar-qty-button senoobar-qty-plus" data-key="<?php echo esc_attr( $cart_item_key ); ?>" aria-label="افزایش تعداد">+</button>
                                            <input type="number" class="senoobar-qty-input" value="<?php echo esc_attr( $cart_item['quantity'] ); ?>" min="1" step="1" inputmode="numeric" data-key="<?php echo esc_attr( $cart_item_key ); ?>" aria-label="تعداد محصول" />
                                            <button type="button" class="senoobar-qty-button senoobar-qty-minus" data-key="<?php echo esc_attr( $cart_item_key ); ?>" aria-label="کاهش تعداد">−</button>
                                        </div>
                                    </div>

                                    <div class="senoobar-cart-subtotal">
                                        <span class="senoobar-mobile-label">جمع</span>
                                        <span><?php echo wp_kses_post( $line_subtotal ); ?></span>
                                    </div>

                                    <div class="senoobar-cart-remove">
                                        <button type="button" class="senoobar-remove-button" data-key="<?php echo esc_attr( $cart_item_key ); ?>" aria-label="حذف <?php echo esc_attr( $product_name ); ?>">
                        ...
                        <div class="senoobar-cart-footer">
                            <a href="<?php echo esc_url( wc_get_page_permalink( 'shop' ) ); ?>" class="senoobar-continue-shopping">
                                <span>←</span> ادامه خرید
                            </a>
                        </div>
                    </div>
                </section>
                ...
                <aside class="senoobar-cart-summary">
                    <div class="senoobar-summary-card">
                        ...
                        <div class="senoobar-summary-row">
                            <span>جمع جزء</span>
                            <strong id="senoobar-cart-subtotal"><?php echo wp_kses_post( $cart->get_cart_subtotal() ); ?></strong>
                        </div>

                        <?php if ( $cart->get_discount_total() > 0 ) : ?>
                            <div class="senoobar-summary-row discount">
                                <span>تخفیف</span>
                                <strong id="senoobar-cart-discount">−<?php echo wp_kses_post( wc_price( $cart->get_discount_total() ) ); ?></strong>
                            </div>
                        <?php endif; ?>
                        ...
                        <div class="senoobar-summary-total">
                            ...
                            <strong id="senoobar-cart-total"><?php echo wp_kses_post( $cart->get_total() ); ?></strong>
                        </div>

                        <!-- Coupon -->
                        <div class="senoobar-coupon">
                            <button type="button" class="senoobar-coupon-toggle" aria-expanded="false">
                                <span>کد تخفیف دارید؟</span><span>+</span>
                            </button>
                            <div class="senoobar-coupon-content">
                                <div class="senoobar-coupon-form">
                                    <input type="text" id="senoobar-coupon-code" placeholder="کد تخفیف" autocomplete="off" />
                                    <button type="button" id="senoobar-apply-coupon">اعمال</button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="senoobar-services-card">
                        <div class="senoobar-service">
                            <span class="senoobar-service-icon">🚚</span>
                            <div><strong>ارسال سریع</strong><small>ارسال مطمئن سفارش</small></div>
                        </div>
                        <div class="senoobar-service">
                            <span class="senoobar-service-icon">🛡️</span>
                            <div><strong>ضمانت کیفیت</strong><small>تضمین کیفیت محصولات</small></div>
                        </div>
                        <div class="senoobar-service">
                            <span class="senoobar-service-icon">🔒</span>
                            <div><strong>پرداخت امن</strong><small>پرداخت امن و مطمئن</small></div>
                        </div>
                    </div>
                </aside>
