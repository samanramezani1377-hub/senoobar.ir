...
if($img2_webp){ echo '<picture><source type="image/webp" srcset="'.esc_url($img2_webp).'">'.senoobar_img($img2, ['alt'=>'اتاق خواب','width'=>$img2_w,'height'=>$img2_h,'loading'=>'eager','fetchpriority'=>'low','decoding'=>'async']).'</picture>'; }
else { echo senoobar_img($img2, ['alt'=>'اتاق خواب','width'=>$img2_w,'height'=>$img2_h,'loading'=>'eager','fetchpriority'=>'low','decoding'=>'async']); }
